...
| 004 | XGB+LGB+CAT 블렌딩 | 0.96893 | 0.96588 |
| 005 | 원본 데이터 + 모델 튜닝 + 균등블렌딩 | 0.96790 | 0.96483 |
| 006 | 전체 파이프라인 XGB 단독 | 0.97542 | 0.97498 |
| 006 | 전체 파이프라인 + Blend + Bias Tuning | **0.97886** | **0.97792** |
